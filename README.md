...
となる、より正確には周期$$1$$の関数$$a$$が存在して上のように書けたとするとき、 $$\e \to 0$$での解$$u_\e$$の挙動、つまり$$u_\e$$は収束するか極限方程式は何かというを考えることになる。
...
を得る。 ここから部分列を取れば$$u_\e$$は$$\e \to 0$$である関数$$u$$に$$H^1_0(\[0, L])$$ソボレフ空間の中で弱収束することがわかる。
